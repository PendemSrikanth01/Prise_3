...
import { AttendanceMode, PrismaClient, OnboardingStatus, OnboardingItemType, SessionStatus, SessionType, StartupStatus, EffortLevel, MilestoneScope } from '@prisma/client';
import bcrypt from 'bcryptjs';
import { BASELINE_SUBTASKS, PROGRAM_ACTIONS } from './program-plan';
...
// -----------------------------------------------------------------------
const STARTUPS = [
  { sNo: 1, name: 'Varahi Medicare', founderName: 'Eati Venkata Naveen Kumar', founderEmail: 'drnk9999@gmail.com', founderPhone: '9959133469', location: 'Vishakapatnam', state: 'Andhra Pradesh', sector: 'Health', legalStructure: 'For-profit company', actualFee: 25000, agreedFee: 25000, totalFeePaid: 0, agreement: 'Sumitted', baseline: 'Sumitted', pitch: 'Sumitted', logo: 'Sumitted', documentFolderLink: 'Varahi Medicare_All Documents_P3.0' },
  { sNo: 2, name: 'MyCheckStore Private Limited', founderName: 'Satya Sai Rajeev Reddy', founderEmail: 'satyasairajeevreddygade@gmail.com', founderPhone: '8333984828', location: 'Nellore', state: 'Andhra Pradesh', sector: 'Rural Retail/Commerce', legalStructure: 'For-profit company', actualFee: 25000, agreedFee: 25000, totalFeePaid: 12500, agreement: 'Sumitted', baseline: 'Sumitted', pitch: 'Sumitted', logo: 'Sumitted', documentFolderLink: 'Mycheckstore_All Documents_P3.0' },
  { sNo: 3, name: 'Gowar Craft LLP', founderName: 'Roushan Kumar', founderEmail: 'gowarcraftsllp@gmail.com', founderPhone: '7004121435', location: 'Ranchi', state: 'Jharkhand', sector: 'Livelihoods', legalStructure: 'Partnership', actualFee: 25000, agreedFee: 25000, agreedFeeRemarks: 'Agreed for October & December', totalFeePaid: 0, agreement: 'Sumitted', baseline: 'Sumitted', pitch: 'Sumitted', logo: 'Sumitted', documentFolderLink: 'Gowar Crafts_All Documents_P3.0' },
  { sNo: 4, name: 'Pravikshya Education Foundation', founderName: 'Veeresh Pani', founderEmail: 'pravikshyaeducation.foundation@gmail.com', founderPhone: '9945892414', location: 'Shahapur Town', state: 'Karnataka', sector: 'Education/Skill Development', legalStructure: 'Section 8 company', actualFee: 25000, agreedFee: 15000, agreedFeeRemarks: 'Agreed to give discount of 40%, to pay 1250 for 12 months', totalFeePaid: 0, agreement: 'Sumitted', baseline: 'Sumitted', pitch: 'Sumitted', logo: 'Sumitted', documentFolderLink: 'Pravikshya_All Documents_P3.0' },
  { sNo: 5, name: 'Marktech Creations Private Limited (PADVERSE)', founderName: 'Manish Sagar Ramarapu', founderEmail: 'ramarapumanish@gmail.com', founderPhone: '9346833224', location: 'Hyderabad', state: 'Telangana', sector: 'Waste Management/Environment', legalStructure: 'For-profit company', actualFee: 25000, agreedFee: 20000, agreedFeeRemarks: 'Agreed to pay 2000 for 10 months', totalFeePaid: 2000, agreement: 'Sumitted', baseline: 'Sumitted', pitch: 'Sumitted', logo: 'Sumitted', documentFolderLink: 'Padverse_All Documents_P3.0' },
  { sNo: 6, name: 'Vasanthi Electricals Pvt Ltd', founderName: 'Akhil', founderEmail: 'sales@vasanthielectricals.com', founderPhone: '7660006354', location: 'Patancheru', state: 'Telangana', sector: 'Electricity', legalStructure: 'For-profit company', actualFee: 25000, agreedFee: 20000, agreedFeeRemarks: 'Agreed to pay 20000 in two installments', totalFeePaid: 20000, agreement: 'Sumitted', baseline: 'Sumitted', pitch: 'Sumitted', logo: 'Sumitted', documentFolderLink: 'Vasanthi Electricals_All Documents_P3.0' },
  { sNo: 7, name: "Late Hari Dada Gare Public Library & Study Center's 'Guidance Gurukul'", founderName: 'Siddhesh Pawar', founderEmail: 'siddhesh.pawar1@gmail.com', founderPhone: '8828225656', location: 'Nashik', state: 'Maharashtra', sector: 'Education/Skill Development', legalStructure: 'Non-profit organization', actualFee: 25000, agreedFee: 25000, agreedFeeRemarks: 'Agreed for 4 installments', totalFeePaid: 6250, agreement: 'Sumitted', baseline: 'Sumitted', pitch: 'Sumitted', logo: 'Sumitted', documentFolderLink: 'Guidance Gurukul_All Documents_P3.0' },
  { sNo: 8, name: 'Resha Pirul', founderName: 'Arjun Mehra', founderEmail: 'mehraarjun4286@gmail.com', founderPhone: '9084427782 / 9873424878', location: 'Nainital', state: 'Uttarakhand', sector: 'Livelihoods', legalStructure: 'For-profit company', actualFee: 25000, agreedFee: 25000, agreedFeeRemarks: 'Agreed for 2 installments (July & October)', totalFeePaid: 12500, agreement: 'Sumitted', baseline: 'Sumitted', pitch: 'Sumitted', logo: 'Sumitted', documentFolderLink: 'Resha Pirul_All Documents_P3.0' },
  { sNo: 9, name: 'Aqua HT', founderName: 'Jerra Swamynathan', founderEmail: 'jerraswamynathan@gmail.com', founderPhone: '9390756095', location: 'Siddipet', state: 'Telangana', sector: 'Health', legalStructure: 'Not Registered', actualFee: 25000, agreedFee: 25000, agreedFeeRemarks: 'Agreed for 5 installments', totalFeePaid: 5000, agreement: 'Sumitted', baseline: 'Sumitted', pitch: 'Sumitted', logo: 'Yet to Submit', documentFolderLink: 'Acqua HT_All Documents_P3.0' },
  { sNo: 10, name: 'Hive Harbor', founderName: 'Sushanth L Ram', founderEmail: 'sisgaya@gmail.com', founderPhone: '8978699668', location: 'Hyderabad', state: 'Telangana', sector: 'Livelihoods', legalStructure: 'Private Limited Company', actualFee: 25000, agreedFee: 25000, agreedFeeRemarks: 'Agreed for 3 installments (August, September and October)', totalFeePaid: 0, agreement: 'Sumitted', baseline: 'Sumitted', pitch: 'Sumitted', logo: 'Sumitted', documentFolderLink: 'Hive Harbor_All Documents_P3.0' },
  { sNo: 11, name: 'VETFARM', founderName: 'Dr. Nileshbhai Shambhubhai Patel', founderEmail: 'pateldrnilesh@gmail.com', founderPhone: '9979857189', location: 'Panchmahal', state: 'Gujarat', sector: 'Agriculture', legalStructure: 'Partnership', actualFee: 25000, agreedFee: 25000, agreedFeeRemarks: 'Full payment done in July 2026', totalFeePaid: 25000, agreement: 'Sumitted', baseline: 'Sumitted', pitch: 'Sumitted', logo: 'Sumitted', documentFolderLink: 'Vetfarm_All Documents_P3.0' },
  { sNo: 12, name: 'GreyMinute Dynamics Pvt Ltd', founderName: 'Sathiya Lakshmi', founderEmail: 'psathiyalakshmi5@gmail.com', founderPhone: '9384965741', location: 'Pudukkottai', state: 'Tamil Nadu', sector: 'Health', legalStructure: 'For-profit company', actualFee: 25000, agreedFee: 25000, agreedFeeRemarks: 'Time relaxation needed (maybe 5 installments)', totalFeePaid: 0, agreement: 'Asked to Discontinue', baseline: 'Asked to Discontinue', pitch: 'Asked to Discontinue', logo: 'Asked to Discontinue', documentFolderLink: 'GreyMinute Dynamics_All Documents_P3.0' },
  { sNo: 13, name: 'Sahasti Solutions and Services Private Limited', founderName: 'Ushanna Shivaram Bandaru', founderEmail: 'sahastipvt.ltd2024@gmail.com', founderPhone: '9985477736', location: 'Hyderabad', state: 'Telangana', sector: 'Agriculture', legalStructure: 'For-profit company', actualFee: 25000, agreedFee: 10000, agreedFeeRemarks: 'Agreed to pay 1000 for 10 months', totalFeePaid: 0, agreement: 'Withdrawn', baseline: 'Withdrawn', pitch: 'Withdrawn', logo: 'Withdrawn', documentFolderLink: 'Sahasti Solutions_All Documents_P3.0' },
  { sNo: 14, name: 'Edu Roboverse', founderName: 'Visshal Srivastava', founderEmail: 'srivastavavishal491@gmail.com', founderPhone: '8452910187', location: 'Varanasi', state: 'Uttar Pradesh', sector: 'Education/Skill Development', legalStructure: 'For-profit company', actualFee: 25000, agreedFee: 25000, totalFeePaid: 0, agreement: 'Asked to Discontinue', baseline: 'Asked to Discontinue', pitch: 'Asked to Discontinue', logo: 'Asked to Discontinue', documentFolderLink: 'Edu Roboserve_All Documents_P3.0' },
  { sNo: 15, name: 'Bacce Foundation', founderName: 'Sandeep Ramesh', founderEmail: 'baccetraining@gmail.com', founderPhone: '9739440889', location: 'Bengaluru', state: 'Karnataka', sector: 'Education', legalStructure: 'Non-profit organization', actualFee: 25000, agreedFee: 25000, totalFeePaid: 0, agreement: 'Asked to Discontinue', baseline: 'Asked to Discontinue', pitch: 'Asked to Discontinue', logo: 'Asked to Discontinue' },
  { sNo: 16, name: 'Tell me', founderName: 'Dr. Siddhant R. Vairagar', founderEmail: 'info@thetellme.com', founderPhone: '7588513526', location: 'Pune', state: 'Maharashtra', sector: 'Health', legalStructure: 'For-profit company', actualFee: 25000, agreedFee: 25000, totalFeePaid: 0, agreement: 'Asked to Discontinue', baseline: 'Asked to Discontinue', pitch: 'Asked to Discontinue', logo: 'Asked to Discontinue' },
  { sNo: 17, name: 'DigitalInfraTech', founderName: 'Raj Soni', founderEmail: 'rajsonicareer01@gmail.com', founderPhone: '7051514790', location: 'Lucknow', state: 'Uttar Pradesh', sector: 'Livelihoods', legalStructure: 'Not Registered', actualFee: 25000, agreedFee: 25000, totalFeePaid: 0, agreement: 'Asked to Discontinue', baseline: 'Asked to Discontinue', pitch: 'Asked to Discontinue', logo: 'Asked to Discontinue' },
  { sNo: 18, name: 'Raasa Karts India Private Limited', founderName: 'Manik Sehgal', founderEmail: 'manik.sehgal@raasakarts.com', founderPhone: '9811259603', location: 'Noida', state: 'Uttar Pradesh', sector: 'Health', legalStructure: 'For-profit company', actualFee: 25000, agreedFee: 20000, totalFeePaid: 0, agreement: 'Asked to Discontinue', baseline: 'Asked to Discontinue', pitch: 'Asked to Discontinue', logo: 'Asked to Discontinue' },
  { sNo: 19, name: 'Wooferzz', founderName: 'Aniruddh Lakha', founderEmail: 'aniruddhlakha16@gmail.com', founderPhone: '7620839823', location: 'Nagpur', state: 'Maharashtra', sector: 'Health', legalStructure: 'For-profit company', actualFee: 25000, agreedFee: 25000, totalFeePaid: 0, agreement: 'Asked to Discontinue', baseline: 'Asked to Discontinue', pitch: 'Asked to Discontinue', logo: 'Asked to Discontinue' },
];
...
async function main() {
  ...
  // Program operations plan. Re-seeding refreshes the draft structure without
  // overwriting live ownership, dates or progress entered by the program team.
  for (const item of PROGRAM_ACTIONS) {
    const action = await prisma.programAction.upsert({
      where: { cohort_phase_title: { cohort: item.cohort, phase: item.phase, title: item.title } },
      update: {
    ...
    if (item.title === 'Baseline & Data Collections') {
      for (const [index, title] of BASELINE_SUBTASKS.entries()) {
        await prisma.programActionSubtask.upsert({
          where: { actionId_title: { actionId: action.id, title } },
          update: { position: index + 1 },
          create: { actionId: action.id, title, position: index + 1 },
        });
      }
    }
  }
  console.log(`Seeded ${PROGRAM_ACTIONS.length} program actions across 8 phases.`);
  ...
  for (const s of STARTUPS) {
    const startupData = {
      ...
      documentFolderLink: 'documentFolderLink' in s ? s.documentFolderLink ?? null : null,
    ...
    const items: { type: OnboardingItemType; raw: string }[] = [
      ...
      { type: OnboardingItemType.DOCUMENT_FOLDER, raw: 'documentFolderLink' in s && s.documentFolderLink ? 'Sumitted' : 'Yet to Submit' },
    ];
  ...
  // --- 4. Source-backed attendance used by the Engagement dashboard ---
  const attendanceEvents = [
    {
      externalEventId: 'prise3-program-launch-2026-07-24',
      title: 'PrISE 3.0 Program Launch',
      type: SessionType.FOUNDER_SHOWCASE,
      startsAt: new Date('2026-07-24T09:30:00+05:30'),
      modes: { 1: AttendanceMode.OFFLINE, 2: AttendanceMode.OFFLINE, 3: AttendanceMode.ONLINE, 4: AttendanceMode.ABSENT, 5: AttendanceMode.OFFLINE, 6: AttendanceMode.ABSENT, 7: AttendanceMode.ONLINE, 8: AttendanceMode.ONLINE, 9: AttendanceMode.OFFLINE, 10: AttendanceMode.OFFLINE, 11: AttendanceMode.OFFLINE, 12: AttendanceMode.ABSENT },
    },
    {
      externalEventId: 'prise3-workshop-1-2026-07-25',
      title: 'WS 1: Impact Model & Pitch Foundation',
      type: SessionType.WORKSHOP,
      startsAt: new Date('2026-07-25T09:30:00+05:30'),
      modes: { 1: AttendanceMode.ABSENT, 2: AttendanceMode.OFFLINE, 3: AttendanceMode.ABSENT, 4: AttendanceMode.OFFLINE, 5: AttendanceMode.OFFLINE, 6: AttendanceMode.ABSENT, 7: AttendanceMode.ABSENT, 8: AttendanceMode.ABSENT, 9: AttendanceMode.OFFLINE, 10: AttendanceMode.OFFLINE, 11: AttendanceMode.OFFLINE, 12: AttendanceMode.ABSENT },
    },
    {
      externalEventId: 'prise3-check-in-2026-08-07',
      title: 'Incubatee Check-In Call',
      type: SessionType.REVIEW,
      startsAt: new Date('2026-08-07T15:00:00+05:30'),
      modes: { 1: AttendanceMode.ONLINE, 2: AttendanceMode.ONLINE, 3: AttendanceMode.ONLINE, 4: AttendanceMode.ONLINE, 5: AttendanceMode.ONLINE, 6: AttendanceMode.ONLINE, 7: AttendanceMode.ONLINE, 8: AttendanceMode.ONLINE, 9: AttendanceMode.ONLINE, 10: AttendanceMode.ONLINE, 11: AttendanceMode.ONLINE, 12: AttendanceMode.ABSENT },
    },
  ] as const;
  ...
  for (const event of attendanceEvents) {
    const session = await prisma.session.upsert({
      ...
      update: { title: event.title, type: event.type, startsAt: event.startsAt, status: SessionStatus.COMPLETED, isCohortWide: true },
      create: { externalEventId: event.externalEventId, title: event.title, type: event.type, startsAt: event.startsAt, status: SessionStatus.COMPLETED, isCohortWide: true, participantIds: [] },
    });
    for (const [sNoText, mode] of Object.entries(event.modes)) {
      const startup = await prisma.startup.findUniqueOrThrow({ where: { sNo: Number(sNoText) }, select: { id: true } });
      await prisma.attendanceRecord.upsert({
        where: { sessionId_startupId: { sessionId: session.id, startupId: startup.id } },
        update: { mode },
        create: { sessionId: session.id, startupId: startup.id, mode },
      });
    }
  }

  console.log('Seeded source-backed attendance for 3 cohort events.');
