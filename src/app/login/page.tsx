...
export default async function LoginPage() {
  ...
  return (
    <main className="grid min-h-screen bg-white lg:grid-cols-[1.1fr_.9fr]">
      ...
      <section className="flex items-center justify-center bg-prise-page p-5 sm:p-10"><div className="w-full max-w-md rounded-[24px] border bg-white p-7 shadow-card sm:p-9"><div className="mb-8 lg:hidden"><div className="inline-flex h-11 w-11 items-center justify-center rounded-xl bg-prise-primary font-bold text-white">P</div></div><AuthPanel /></div></section>
    </main>
  );
}
