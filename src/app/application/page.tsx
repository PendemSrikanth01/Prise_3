import { CheckCircle2, Clock3, Download, LogOut } from 'lucide-react';
...
export default async function ApplicationPage() {
  ...
  const startup = await prisma.startup.findFirst({
    ...
    include: { onboardingItems: { orderBy: { type: 'asc' }, include: { documents: { orderBy: { createdAt: 'desc' }, include: { uploader: { select: { name: true } } } } } } },
  });
